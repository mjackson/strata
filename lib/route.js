 ...
 */
function routeMiddleware(app) {
    app = app || utils.notFound;

    var routes = {};

    function route(env, callback) {
     ...
     */
    route.route = function (pattern, app, methods) {
        methods = methods || ["ANY"];
    ...
    for (var method in methods) {
        (function (verbs) {
            route[method] = function (pattern, app) {
