    ...
    if (this.mediaType === "application/json") {
        ...
        input.on("end", function () {
            try {
                ...
                var err = new errors.InvalidRequestBodyError("Invalid JSON", e);
                callback(err, {});
            }
        });
        ...
        if (match) {
            ...
            try {
                ...
                callback(new errors.Error(message, e), params);
                return;
            }
            ...
            input.on("data", function (buffer) {
                ...
                if (length !== buffer.length) {
                    ...
                    callback(new errors.InvalidRequestBody(message), params);
                }
            });
            ...
            input.on("end", function () {
                try {
                    ...
                    callback(new errors.InvalidRequestBody(message, e), params);
                }
            });
        } else {
