var util = require("util"),
    ...
    utils = require("./utils"),
    serverTimeoutMiddleware = require('./servertimeout');
...
function createServer(app, opts) {
    ...
    exports.use(serverTimeoutMiddleware, handleError);
 ...
 *   - serverTimeout        The number of milliseconds to wait before aborting
 */
function makeEnv(opts) {
    ...
    env.serverTimeout = opts.serverTimeout || 100;
