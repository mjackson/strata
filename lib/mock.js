...
function getStatus(opts, app, callback) {
    request(opts, app, function (status, headers, body) {
        callback(null, status);
    });
}

function getHeaders(opts, app, callback) {
    request(opts, app, function (status, headers, body) {
...
/**
 * Buffers the entire body of the response and passes it to the given
 * +callback+. Useful for async testing scenarios that need to test the contents
 * of the response body.
 */
function getBody(opts, app, callback) {
    request(opts, app, function (status, headers, body) {
