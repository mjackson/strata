...
// Some code in this file is based on the ejs templating system,
// written by TJ Holowaychuk. MIT licensed.
...
function compile(template, options) {
    ...
    var inner = new Function(args, body);
