...
/**
 * Buffers all data from the given stream and calls the callback with one
 * Buffer when done.
 */
...
var STATUS_CODES = {};
utils.STATUS_CODES = STATUS_CODES;

// A map of HTTP status messages to their codes.
var STATUS_MESSAGES = {};
utils.STATUS_MESSAGES = STATUS_MESSAGES;
...
utils.STATUS_WITH_NO_ENTITY_BODY = STATUS_WITH_NO_ENTITY_BODY;
 ...
 */
utils.isEmptyBodyStatus = isEmptyBodyStatus;
...
utils.SAFE_REQUEST_METHODS = SAFE_REQUEST_METHODS;

/**
 * Returns true if the given request method is "safe".
 * See utils.SAFE_REQUEST_METHODS.
 */
utils.isSafeRequestMethod = isSafeRequestMethod;
 ...
 */
utils.canonicalHeaderName = canonicalHeaderName;
 ...
 */
utils.capitalizedHeaderName = capitalizedHeaderName;
 ...
 * "x-forwarded-ssl" => "xForwardedSsl"
 */
utils.propertyName = propertyName;
 ...
 */
utils.byteSizeFormat = byteSizeFormat;
 ...
 * resulting RegExp.
 */
utils.compileRoute = compileRoute;
 ...
 */
utils.compareLength = compareLength;
...
utils.ok = makeResponderForStatus(200);
utils.badRequest = makeResponderForStatus(400);
utils.forbidden = makeResponderForStatus(403);
utils.serverError = makeResponderForStatus(500);
