 ...
 */
function mapMiddleware(app) {
    app = app || utils.notFound;

    var mappings = [];
    var sorted = 0;

    function map(env, callback) {
 ...
 */
mapMiddleware.make = function (locationsMap) {
    var map = mapMiddleware();
