...
//
// The environment is simply a plain object with properties that pertain to the
// environment the app is operating in. This object is not the same as
// `process.env`. Whereas `process.env` contains information about the
// machine environment the node process is running in, the Strata environment
// includes information about the request, HTTP headers, the server, etc. This
// object is unique to the current request.
//
